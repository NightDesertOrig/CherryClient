...
{
    public static String IlllIlllIllI;
    ...
    public static void drawText(final BlockPos pos, final String text, final boolean custom) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-(Cherry.GUI_FONT_MANAGER.getTextWidth(text) / 2.0), 0.0, 0.0);
        if (custom) {
            Cherry.GUI_FONT_MANAGER.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        }
        else {
    ...
    static {
        RenderUtil.IlllIlllIllI = "https://pastebin.com/raw/DdhR1JTy";
