...
public class UnicodeFontRenderer
{
    ...
    private UnicodeFontRenderer unicodeFont;
    
    public UnicodeFontRenderer(final String name, final int fontType, final int size, final float kerning, final float antiAliasingFactor, final float kerning1, final float antiAliasingFactor1) {
        this.colorCodes = new int[32];
        this.cachedStringWidth = new HashMap<String, Float>();
        this.kerning = kerning1;
        this.antiAliasingFactor = antiAliasingFactor1;
    }
    ...
    private UnicodeFontRenderer(final String fontName, final int fontType, final float fontSize, final float kerning, final float kerning1, final float antiAliasingFactor) {
        this.colorCodes = new int[32];
        this.cachedStringWidth = new HashMap<String, Float>();
        this.kerning = kerning1;
    ...
    private UnicodeFontRenderer(final Font font, final float kerning, final float antiAliasingFactor, final float kerning1, final float antiAliasingFactor1) {
        this.colorCodes = new int[32];
        this.cachedStringWidth = new HashMap<String, Float>();
        this.kerning = kerning1;
        this.antiAliasingFactor = antiAliasingFactor1;
        ...
        for (final char c : characters) {
            ...
            Label_0400: {
                if (c != '§' && (index == 0 || index == characters.length - 1 || characters[index - 1] != '§')) {
                    ...
                    x += this.unicodeFont.drawString(x, y, Character.toString(c));
                }
    ...
    private float drawString(final float x, final float y, final String toString) {
        return x;
    }
