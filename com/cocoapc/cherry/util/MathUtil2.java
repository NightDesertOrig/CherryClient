...
public class MathUtil2 implements Util
{
    ...
    public static double[] directionSpeed(final double speed) {
        float forward = MathUtil2.mc.player.movementInput.moveForward;
        float side = MathUtil2.mc.player.movementInput.moveStrafe;
        float yaw = MathUtil2.mc.player.prevRotationYaw + (MathUtil2.mc.player.rotationYaw - MathUtil2.mc.player.prevRotationYaw) * MathUtil2.mc.getRenderPartialTicks();
        if (forward != 0.0f) {
            if (side > 0.0f) {
