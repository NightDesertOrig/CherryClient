...
public class RenderUtil implements Util
{
    ...
    public static final class GeometryMasks
    {
        ...
        public static void drawColorBox(final int n, final int n2, final int n3, final int n4) {
            final AxisAlignedBB axisAlignedBB = new AxisAlignedBB(n - RenderUtil.mc.getRenderManager().viewerPosX, n2 - RenderUtil.mc.getRenderManager().viewerPosY, n3 - RenderUtil.mc.getRenderManager().viewerPosZ, n + 1 - RenderUtil.mc.getRenderManager().viewerPosX, n2 + 1 - RenderUtil.mc.getRenderManager().viewerPosY, n3 + 1 - RenderUtil.mc.getRenderManager().viewerPosZ);
            RenderUtil.camera.setPosition(RenderUtil.mc.getRenderViewEntity().posX, RenderUtil.mc.getRenderViewEntity().posY, RenderUtil.mc.getRenderViewEntity().posZ);
            if (RenderUtil.camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB.minX + RenderUtil.mc.getRenderManager().viewerPosX, axisAlignedBB.minY + RenderUtil.mc.getRenderManager().viewerPosY, axisAlignedBB.minZ + RenderUtil.mc.getRenderManager().viewerPosZ, axisAlignedBB.maxX + RenderUtil.mc.getRenderManager().viewerPosX, axisAlignedBB.maxY + RenderUtil.mc.getRenderManager().viewerPosY, axisAlignedBB.maxZ + RenderUtil.mc.getRenderManager().viewerPosZ))) {
                ...
                RenderUtil.drawBoundingBox(axisAlignedBB, 1.0f, n4);
                RenderUtil.drawFilledBox(axisAlignedBB, n4);
                GL11.glDisable(2848);
                GlStateManager.depthMask(true);
                GlStateManager.enableDepth();
                GlStateManager.enableTexture2D();
