...
public class RenderUtil2 implements Util
{
    ...
    public static void boxESP(final BlockPos blockPos, final Color color, final float f, final boolean bl, final boolean bl2, final int n, final boolean bl3) {
        ...
        if (RenderUtil2.camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB.minX + RenderUtil2.mc.getRenderManager().viewerPosX, axisAlignedBB.minY + RenderUtil2.mc.getRenderManager().viewerPosY, axisAlignedBB.minZ + RenderUtil2.mc.getRenderManager().viewerPosZ, axisAlignedBB.maxX + RenderUtil2.mc.getRenderManager().viewerPosX, axisAlignedBB.maxY + RenderUtil2.mc.getRenderManager().viewerPosY, axisAlignedBB.maxZ + RenderUtil2.mc.getRenderManager().viewerPosZ))) {
            ...
            GL11.glLineWidth(f);
            final double d8 = RenderUtil2.mc.playerController.curBlockDamageMP;
            float f2 = Speedmine3.getInstance().timer.getPassedTimeMs() / 1000.0f / (Speedmine3.getInstance().breakTime * Cherry.serverManager.getTpsFactor());
            f2 = Math.min(f2, 1.0f);
            double d9;
            double d10;
            double d11;
    ...
    public static void drawWaypointImage(final BlockPos pos, final GLUProjection.Projection projection, final Color color, final String name, final boolean rectangle, final Color rectangleColor) {
        ...
        final String text = name + ": " + Math.round(RenderUtil2.mc.player.getDistance((double)pos.getX(), (double)pos.getY(), (double)pos.getZ())) + "M";
        final float textWidth = (float)Cherry.textManager.getStringWidth(text);
        Cherry.textManager.drawString(text, -(textWidth / 2.0f), -(Cherry.textManager.getFontHeight() / 2.0f) + Cherry.textManager.getFontHeight() / 2.0f, color.getRGB(), false);
        GlStateManager.translate(-projection.getX(), -projection.getY(), 0.0);
        GlStateManager.popMatrix();
    }
    ...
    public static void drawGradientPlane(final BlockPos pos, final EnumFacing face, final Color startColor, final Color endColor, final boolean half, final boolean top) {
        ...
        final AxisAlignedBB bb = iblockstate.getSelectedBoundingBox((World)RenderUtil2.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z);
    ...
    public static void drawGradientPlane(final BlockPos pos, final EnumFacing face, final Color startColor, final Color endColor, final double height) {
        ...
        final IBlockState iblockstate = RenderUtil2.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil2.mc.player, RenderUtil2.mc.getRenderPartialTicks());
        final AxisAlignedBB bb = iblockstate.getSelectedBoundingBox((World)RenderUtil2.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z).expand(0.0, height, 0.0);
        final float red = startColor.getRed() / 255.0f;
        final float green = startColor.getGreen() / 255.0f;
        final float blue = startColor.getBlue() / 255.0f;
        final float alpha = startColor.getAlpha() / 255.0f;
    ...
    public static void drawGradientBlockOutline(final BlockPos pos, final Color startColor, final Color endColor, final float linewidth, final double height) {
        final IBlockState iblockstate = RenderUtil2.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil2.mc.player, RenderUtil2.mc.getRenderPartialTicks());
        drawGradientBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtil2.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z).expand(0.0, height, 0.0), startColor, endColor, linewidth);
    }
    ...
    public static void drawProperGradientBlockOutline(final BlockPos pos, final Color startColor, final Color midColor, final Color endColor, final float linewidth) {
        final IBlockState iblockstate = RenderUtil2.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil2.mc.player, RenderUtil2.mc.getRenderPartialTicks());
        drawProperGradientBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtil2.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), startColor, midColor, endColor, linewidth);
    }
    ...
    public static void drawGradientFilledBox(final BlockPos pos, final Color startColor, final Color endColor) {
        final IBlockState iblockstate = RenderUtil2.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil2.mc.player, RenderUtil2.mc.getRenderPartialTicks());
        drawGradientFilledBox(iblockstate.getSelectedBoundingBox((World)RenderUtil2.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), startColor, endColor);
    }
    ...
    public static void drawBox(final BlockPos pos, final Color color, final double height, final boolean gradient, final boolean invert, final int alpha) {
        ...
        final AxisAlignedBB bb = new AxisAlignedBB(pos.getX() - RenderUtil2.mc.getRenderManager().viewerPosX, pos.getY() - RenderUtil2.mc.getRenderManager().viewerPosY, pos.getZ() - RenderUtil2.mc.getRenderManager().viewerPosZ, pos.getX() + 1 - RenderUtil2.mc.getRenderManager().viewerPosX, pos.getY() + 1 - RenderUtil2.mc.getRenderManager().viewerPosY + height, pos.getZ() + 1 - RenderUtil2.mc.getRenderManager().viewerPosZ);
        RenderUtil2.camera.setPosition(Objects.requireNonNull(RenderUtil2.mc.getRenderViewEntity()).posX, RenderUtil2.mc.getRenderViewEntity().posY, RenderUtil2.mc.getRenderViewEntity().posZ);
        if (RenderUtil2.camera.isBoundingBoxInFrustum(new AxisAlignedBB(bb.minX + RenderUtil2.mc.getRenderManager().viewerPosX, bb.minY + RenderUtil2.mc.getRenderManager().viewerPosY, bb.minZ + RenderUtil2.mc.getRenderManager().viewerPosZ, bb.maxX + RenderUtil2.mc.getRenderManager().viewerPosX, bb.maxY + RenderUtil2.mc.getRenderManager().viewerPosY, bb.maxZ + RenderUtil2.mc.getRenderManager().viewerPosZ))) {
            GlStateManager.pushMatrix();
            GlStateManager.enableBlend();
    ...
    public static void drawBlockOutline(final BlockPos pos, final Color color, final float linewidth, final boolean air) {
        ...
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtil2.mc.world.getWorldBorder().contains(pos)) {
            final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil2.mc.player, RenderUtil2.mc.getRenderPartialTicks());
            RenderUtil.drawBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtil2.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), color, linewidth);
        }
    }
    ...
    public static void drawBlockOutline(final BlockPos pos, final Color color, final float linewidth, final boolean air, final double height, final boolean gradient, final boolean invert, final int alpha) {
        ...
        final IBlockState iblockstate = RenderUtil2.mc.world.getBlockState(pos);
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtil2.mc.world.getWorldBorder().contains(pos)) {
            final AxisAlignedBB blockAxis = new AxisAlignedBB(pos.getX() - RenderUtil2.mc.getRenderManager().viewerPosX, pos.getY() - RenderUtil2.mc.getRenderManager().viewerPosY, pos.getZ() - RenderUtil2.mc.getRenderManager().viewerPosZ, pos.getX() + 1 - RenderUtil2.mc.getRenderManager().viewerPosX, pos.getY() + 1 - RenderUtil2.mc.getRenderManager().viewerPosY + height, pos.getZ() + 1 - RenderUtil2.mc.getRenderManager().viewerPosZ);
    ...
    public static void drawText(final AxisAlignedBB pos, final String text) {
        ...
        GlStateManager.pushMatrix();
        RenderUtil.glBillboardDistanceScaled((float)pos.minX + 0.5f, (float)pos.minY + 0.5f, (float)pos.minZ + 0.5f, (EntityPlayer)RenderUtil2.mc.player, 1.0f);
        GlStateManager.disableDepth();
        GlStateManager.translate(-(Cherry.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
        Cherry.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.popMatrix();
    }
    ...
    public static void drawOutlinedBlockESP(final BlockPos pos, final Color color, final float linewidth) {
        final IBlockState iblockstate = RenderUtil2.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil2.mc.player, RenderUtil2.mc.getRenderPartialTicks());
        RenderUtil.drawBoundingBox(iblockstate.getSelectedBoundingBox((World)RenderUtil2.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), linewidth, ColorUtil.toRGBA(color));
    }
    ...
    public static void drawProjectedText(final GLUProjection.Projection projection, final float addX, final float addY, final String text, final Color color, final boolean shadow) {
        if (projection.getType() == GLUProjection.Projection.Type.INSIDE) {
            GlStateManager.pushMatrix();
            GlStateManager.translate(projection.getX(), projection.getY(), 0.0);
            Cherry.textManager.drawString(text, -(Cherry.textManager.getStringWidth(text) / 2.0f) + addX, addY, color.getRGB(), shadow);
            GlStateManager.translate(-projection.getX(), -projection.getY(), 0.0);
            GlStateManager.popMatrix();
        }
    }
