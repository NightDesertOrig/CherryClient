...
public class RenderUtil3 implements Util
{
    ...
    public static void boxESP(final BlockPos blockPos, final Color color, final float f, final boolean bl, final boolean bl2, final int n, final boolean bl3) {
        final AxisAlignedBB axisAlignedBB = new AxisAlignedBB(blockPos.getX() - RenderUtil3.mc.getRenderManager().viewerPosX, blockPos.getY() - RenderUtil3.mc.getRenderManager().viewerPosY, blockPos.getZ() - RenderUtil3.mc.getRenderManager().viewerPosZ, blockPos.getX() + 1 - RenderUtil3.mc.getRenderManager().viewerPosX, blockPos.getY() + 1 - RenderUtil3.mc.getRenderManager().viewerPosY, blockPos.getZ() + 1 - RenderUtil3.mc.getRenderManager().viewerPosZ);
        ...
        if (RenderUtil3.camera.isBoundingBoxInFrustum(new AxisAlignedBB(axisAlignedBB.minX + RenderUtil3.mc.getRenderManager().viewerPosX, axisAlignedBB.minY + RenderUtil3.mc.getRenderManager().viewerPosY, axisAlignedBB.minZ + RenderUtil3.mc.getRenderManager().viewerPosZ, axisAlignedBB.maxX + RenderUtil3.mc.getRenderManager().viewerPosX, axisAlignedBB.maxY + RenderUtil3.mc.getRenderManager().viewerPosY, axisAlignedBB.maxZ + RenderUtil3.mc.getRenderManager().viewerPosZ))) {
            ...
            GL11.glLineWidth(f);
            final double d8 = RenderUtil3.mc.playerController.curBlockDamageMP;
    ...
    public static void updateModelViewProjectionMatrix() {
        ...
        GLUProjection.getInstance().updateMatrices(RenderUtil3.viewport, RenderUtil3.modelView, RenderUtil3.projection, (double)(res.getScaledWidth() / (float)Minecraft.getMinecraft().displayWidth), (double)(res.getScaledHeight() / (float)Minecraft.getMinecraft().displayHeight));
    }
    ...
    public static void drawWaypointImage(final BlockPos pos, final GLUProjection.Projection projection, final Color color, final String name, final boolean rectangle, final Color rectangleColor) {
        ...
        final String text = name + ": " + Math.round(RenderUtil3.mc.player.getDistance((double)pos.getX(), (double)pos.getY(), (double)pos.getZ())) + "M";
    ...
    public static void drawGradientPlane(final BlockPos pos, final EnumFacing face, final Color startColor, final Color endColor, final boolean half, final boolean top) {
        ...
        final AxisAlignedBB bb = iblockstate.getSelectedBoundingBox((World)RenderUtil3.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z);
    ...
    public static void drawProperGradientBlockOutline(final BlockPos pos, final Color startColor, final Color midColor, final Color endColor, final float linewidth) {
        final IBlockState iblockstate = RenderUtil3.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil3.mc.player, RenderUtil3.mc.getRenderPartialTicks());
        drawProperGradientBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtil3.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), startColor, midColor, endColor, linewidth);
    }
    ...
    public static void drawGradientFilledBox(final BlockPos pos, final Color startColor, final Color endColor) {
        final IBlockState iblockstate = RenderUtil3.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil3.mc.player, RenderUtil3.mc.getRenderPartialTicks());
        drawGradientFilledBox(iblockstate.getSelectedBoundingBox((World)RenderUtil3.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), startColor, endColor);
    }
    ...
    public static void drawBlockOutline(final BlockPos pos, final Color color, final float linewidth, final boolean air) {
        ...
        if ((air || iblockstate.getMaterial() != Material.AIR) && RenderUtil3.mc.world.getWorldBorder().contains(pos)) {
            final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil3.mc.player, RenderUtil3.mc.getRenderPartialTicks());
            RenderUtil.drawBlockOutline(iblockstate.getSelectedBoundingBox((World)RenderUtil3.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), color, linewidth);
        }
    }
    ...
    public static void drawText(final AxisAlignedBB pos, final String text) {
        ...
        GlStateManager.pushMatrix();
        RenderUtil.glBillboardDistanceScaled((float)pos.minX + 0.5f, (float)pos.minY + 0.5f, (float)pos.minZ + 0.5f, (EntityPlayer)RenderUtil3.mc.player, 1.0f);
        GlStateManager.disableDepth();
    ...
    public static void drawOutlinedBlockESP(final BlockPos pos, final Color color, final float linewidth) {
        final IBlockState iblockstate = RenderUtil3.mc.world.getBlockState(pos);
        final Vec3d interp = EntityUtil.interpolateEntity((Entity)RenderUtil3.mc.player, RenderUtil3.mc.getRenderPartialTicks());
        RenderUtil.drawBoundingBox(iblockstate.getSelectedBoundingBox((World)RenderUtil3.mc.world, pos).grow(0.0020000000949949026).offset(-interp.x, -interp.y, -interp.z), linewidth, ColorUtil.toRGBA(color));
    }
