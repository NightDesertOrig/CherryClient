...
public class EntityUtil implements Util
{
    ...
    public static List<EntityPlayer> getPlayers() {
        return (List<EntityPlayer>)EntityUtil.mc.world.playerEntities.stream().filter(e -> e.entityId != EntityUtil.mc.player.entityId).collect(Collectors.toList());
    }
    ...
    public static boolean getSurroundWeakness(final Vec3d pos, final int feetMine, final int render) {
        switch (feetMine) {
            case 1: {
                ...
                if (!BlockUtil2.canBlockBeSeen((double)(raytrace.getX() - 2), (double)raytrace.getY(), (double)raytrace.getZ()) && Math.sqrt(EntityUtil.mc.player.getDistanceSq((double)(raytrace.getX() - 2), (double)raytrace.getY(), (double)raytrace.getZ())) > 3.0) {
                    return false;
                }
            ...
            case 3: {
                final BlockPos raytrace = new BlockPos(pos);
                if (!BlockUtil2.canBlockBeSeen((double)raytrace.getX(), (double)raytrace.getY(), (double)(raytrace.getZ() - 2)) && Math.sqrt(EntityUtil.mc.player.getDistanceSq((double)raytrace.getX(), (double)raytrace.getY(), (double)(raytrace.getZ() - 2))) > 3.0) {
                    return false;
                }
            ...
            case 5: {
                final BlockPos raytrace = new BlockPos(pos);
                if (!BlockUtil2.canBlockBeSeen((double)(raytrace.getX() - 1), (double)raytrace.getY(), (double)raytrace.getZ()) && Math.sqrt(EntityUtil.mc.player.getDistanceSq((double)(raytrace.getX() - 1), (double)raytrace.getY(), (double)raytrace.getZ())) > 3.0) {
                    return false;
                }
            ...
            case 7: {
                final BlockPos raytrace = new BlockPos(pos);
                if (!BlockUtil2.canBlockBeSeen((double)raytrace.getX(), (double)raytrace.getY(), (double)(raytrace.getZ() - 1)) && Math.sqrt(EntityUtil.mc.player.getDistanceSq((double)raytrace.getX(), (double)raytrace.getY(), (double)(raytrace.getZ() - 1))) > 3.0) {
                    return false;
                }
        ...
        switch (render) {
            case 1: {
                ...
                return (blockb == Blocks.OBSIDIAN || blockb == Blocks.BEDROCK) && EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-1, 0, 0)).getBlock() != Blocks.BEDROCK;
            }
            case 2: {
                final Block block2 = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(2, 1, 0)).getBlock();
                if (block2 != Blocks.AIR && block2 != Blocks.FIRE) {
            ...
            case 3: {
                ...
                return (blockb == Blocks.OBSIDIAN || blockb == Blocks.BEDROCK) && EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 0, -1)).getBlock() != Blocks.BEDROCK;
            }
            case 4: {
                final Block block2 = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 1, 2)).getBlock();
                if (block2 != Blocks.AIR && block2 != Blocks.FIRE) {
            ...
            case 5: {
                ...
                return (block2 == Blocks.AIR || block2 == Blocks.FIRE) && EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(-1, 0, 0)).getBlock() != Blocks.BEDROCK;
            }
            case 6: {
                final Block block2 = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(1, 1, 0)).getBlock();
                return (block2 == Blocks.AIR || block2 == Blocks.FIRE) && EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(1, 0, 0)).getBlock() != Blocks.BEDROCK;
            ...
            case 7: {
                ...
                return (block2 == Blocks.AIR || block2 == Blocks.FIRE) && EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 0, -1)).getBlock() != Blocks.BEDROCK;
            }
            case 8: {
                final Block block2 = EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 1, 1)).getBlock();
                return (block2 == Blocks.AIR || block2 == Blocks.FIRE) && EntityUtil.mc.world.getBlockState(new BlockPos(pos).add(0, 0, 1)).getBlock() != Blocks.BEDROCK;
    ...
    public static EntityLivingBase getTarget(final boolean players, final boolean neutral, final boolean friends, final boolean hostile, final boolean passive, final double range, final int mode) {
        final EntityLivingBase entity = null;
        return entity;
    }
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtil.mc.player) || (entity instanceof EntityPlayer && Cherry.friendManager.isFriend(entity.getName())) || EntityUtil.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    
    public static boolean isValid(final Entity entity, final boolean players, final boolean neutral, final boolean friends, final boolean hostile, final boolean passive, final double range) {
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            if (!player.isInvisible()) {
                ...
                output.put(healthSB.toString() + " " + (Cherry.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.getName() + " " + distanceSB.toString() + " \u00c2§f0", (int)EntityUtil.mc.player.getDistance((Entity)player));
