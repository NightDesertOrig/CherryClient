...
public class Off implements Globals
{
    public static final ISound sound;
    private static final String song = "off";
    private static final ResourceLocation loc;
    
    static {
        loc = new ResourceLocation("sounds/off.ogg");
        sound = (ISound)new ISound() {
            ...
            public SoundEventAccessor createAccessor(final SoundHandler soundHandler) {
                return new SoundEventAccessor(Off.loc, "Off");
            }
            
            public Sound getSound() {
                return new Sound("off", 1.0f, 1.0f, 1, Sound.Type.SOUND_EVENT, false);
            }
