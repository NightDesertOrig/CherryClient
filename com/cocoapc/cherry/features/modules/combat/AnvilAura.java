...
public class AnvilAura extends Module
{
    ...
    public AnvilAura() {
        super("AnvilAura", "", Category.COMBAT, true, false, false);
        ...
        this.breakPos = null;
        this.attempts = 0;
        this.targetType = (Setting<type>)this.register(new Setting("A", (T)type.NEAREST));
        this.breakMode = (Setting<mode>)this.register(new Setting("A A", (T)mode.Vanilla));
        this.rotate = (Setting<Boolean>)this.register(new Setting("A", (T)true));
        this.startDelay = (Setting<Integer>)this.register(new Setting("A", (T)1, (T)0, (T)10));
        this.breakDelay = (Setting<Integer>)this.register(new Setting("A", (T)1, (T)0, (T)10));
        this.crystalDelay = (Setting<Integer>)this.register(new Setting("A", (T)1, (T)0, (T)10));
        this.hitDelay = (Setting<Integer>)this.register(new Setting("A", (T)3, (T)0, (T)10));
        this.nosleep = (Setting<Integer>)this.register(new Setting("A", (T)3, (T)0, (T)10));
        this.timer = 0;
    }
    ...
    public int onTick() {
        ...
        final int crystal = this.findMaterials(Blocks.ANVIL);
        final int obby = this.findMaterials(Blocks.ANVIL);
