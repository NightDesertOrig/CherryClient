...
public class Components extends Module
{
    ...
    public Components() {
        super("HUD MAIN", "\u8a73\u7d30\u306aHUD\u8a2d\u5b9a", Category.CLIENT, false, false, true);
        ...
        this.imageLogo = (Setting<Boolean>)this.register(new Setting("ImageLogo", (T)true));
        this.imageX = (Setting<Integer>)this.register(new Setting("ImageX", (T)(-35), (T)(-100), (T)1000, v -> this.imageLogo.getValue()));
        this.imageY = (Setting<Integer>)this.register(new Setting("ImageY", (T)(-48), (T)(-100), (T)1000, v -> this.imageLogo.getValue()));
        this.imageWidth = (Setting<Integer>)this.register(new Setting("ImageWidth", (T)177, (T)0, (T)1000, v -> this.imageLogo.getValue()));
        this.imageHeight = (Setting<Integer>)this.register(new Setting("ImageHeight", (T)142, (T)0, (T)1000, v -> this.imageLogo.getValue()));
        this.imageLogo2 = (Setting<Boolean>)this.register(new Setting("ImageLogo", (T)false));
        this.imageX2 = (Setting<Integer>)this.register(new Setting("ImageX", (T)497, (T)0, (T)1000, v -> this.imageLogo.getValue()));
        this.imageY2 = (Setting<Integer>)this.register(new Setting("ImageY", (T)230, (T)0, (T)1000, v -> this.imageLogo.getValue()));
        this.imageWidth2 = (Setting<Integer>)this.register(new Setting("ImageWidth", (T)194, (T)0, (T)1000, v -> this.imageLogo.getValue()));
        this.imageHeight2 = (Setting<Integer>)this.register(new Setting("ImageHeight", (T)182, (T)0, (T)1000, v -> this.imageLogo.getValue()));
