...
public class Chams extends Module
{
    ...
    public Chams() {
        ...
        this.rainbow = (Setting<Boolean>)this.register(new Setting("Rainbow", (T)Boolean.FALSE, v -> this.colored.getValue()));
        ...
        this.xqz = (Setting<Boolean>)this.register(new Setting("XQZ", (T)Boolean.FALSE, v -> this.colored.getValue() && !this.rainbow.getValue()));
