...
public class TestNametags extends Module
{
    ...
    public TestNametags() {
        ...
        this.health = (Setting<Boolean>)this.register(new Setting("Health", (T)Boolean.TRUE));
        this.armor = (Setting<Boolean>)this.register(new Setting("Armor", (T)Boolean.TRUE));
        this.reverseArmor = (Setting<Boolean>)this.register(new Setting("ReverseArmor", (T)Boolean.FALSE));
        this.topEnchant = (Setting<Boolean>)this.register(new Setting("TopEnchant", (T)Boolean.FALSE));
        this.scaling = (Setting<Float>)this.register(new Setting("Size", (T)0.3f, (T)0.1f, (T)20.0f));
        this.invisibles = (Setting<Boolean>)this.register(new Setting("Invisibles", (T)Boolean.FALSE));
        this.ping = (Setting<Boolean>)this.register(new Setting("Ping", (T)Boolean.TRUE));
        this.gamemode = (Setting<Boolean>)this.register(new Setting("Gamemode", (T)Boolean.FALSE));
        this.entityID = (Setting<Boolean>)this.register(new Setting("ID", (T)Boolean.FALSE));
        this.rect = (Setting<Boolean>)this.register(new Setting("Rectangle", (T)Boolean.TRUE));
        ...
        this.sneak = (Setting<Boolean>)this.register(new Setting("SneakColor", (T)Boolean.FALSE));
        this.heldStackName = (Setting<Boolean>)this.register(new Setting("StackName", (T)Boolean.FALSE));
        this.whiter = (Setting<Boolean>)this.register(new Setting("White", (T)Boolean.FALSE));
        this.onlyFov = (Setting<Boolean>)this.register(new Setting("OnlyFov", (T)Boolean.FALSE));
        this.scaleing = (Setting<Boolean>)this.register(new Setting("Scale", (T)Boolean.FALSE));
