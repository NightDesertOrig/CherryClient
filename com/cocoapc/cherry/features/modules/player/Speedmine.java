...
public class Speedmine extends Module
{
    ...
    public int onUpdate() {
        ...
        return Speedmine.mc.playerController.blockHitDelay = 0;
    }
    
    public void onRender3D(final Render3DEvent event) {
        if (this.render.getValue() && this.currentPos != null && this.currentBlockState.getBlock() == Blocks.OBSIDIAN) {
            final Color color = new Color(this.timer.passedMs((int)(2000.0f * Cherry.serverManager.getTpsFactor())) ? 0 : 255, this.timer.passedMs((int)(2000.0f * Cherry.serverManager.getTpsFactor())) ? 255 : 0, 0, 255);
