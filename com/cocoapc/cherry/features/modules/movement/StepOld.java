...
public class StepOld extends Module
{
    ...
    public StepOld() {
        ...
        this.spoof = (Setting<Boolean>)this.register(new Setting("Spoof", (T)Boolean.TRUE, v -> !this.vanilla.getValue()));
        this.ticks = (Setting<Integer>)this.register(new Setting("Delay", (T)3, (T)0, (T)25, v -> this.spoof.getValue() && !this.vanilla.getValue()));
        this.turnOff = (Setting<Boolean>)this.register(new Setting("Disable", (T)Boolean.FALSE, v -> !this.vanilla.getValue()));
        this.check = (Setting<Boolean>)this.register(new Setting("Check", (T)Boolean.TRUE, v -> !this.vanilla.getValue()));
        this.small = (Setting<Boolean>)this.register(new Setting("Offset", (T)Boolean.FALSE, v -> this.stepHeight.getValue() > 1 && !this.vanilla.getValue()));
