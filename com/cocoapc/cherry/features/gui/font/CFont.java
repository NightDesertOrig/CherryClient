...
package com.cocoapc.cherry.features.gui.font;
...
public class CFont
{
    ...
    public CFont(final com.cocoapc.cherry.features.gui.CFont.CustomFont font, final boolean antiAlias, final boolean fractionalMetrics) {
        this.charData = new CharData[256];
        this.fontHeight = -1;
        this.charOffset = 0;
    }
    
    public CFont(final com.cocoapc.cherry.features.gui.noti.CFont.CustomFont customFont, final boolean antiAlias, final boolean fractionalMetrics, final int[] colorCode) {
        this.charData = new CharData[256];
        this.fontHeight = -1;
        this.charOffset = 0;
    }
