...
package com.cocoapc.cherry.features.gui.newgui;
...
public class NewCherryGui extends GuiScreen
{
    public String moving;
    private Component hubComponent;
    private static NewCherryGui sweetplusGui;
    private static NewCherryGui INSTANCE;
    Random random;
    ...
    public static NewCherryGui getInstance() {
        if (NewCherryGui.INSTANCE == null) {
            NewCherryGui.INSTANCE = new NewCherryGui();
        }
        return NewCherryGui.INSTANCE;
    }
    ...
    public static NewCherryGui getClickGui() {
        return getInstance();
    }
    
    private void setInstance() {
        NewCherryGui.INSTANCE = this;
    }
        ...
        for (final Module.Category category : Cherry.moduleManager.getCategories()) {
            ...
            components2.add(new Component(name, x, 4, true) {
                public void setupItems() {
                    NewCherryGui$1.counter1 = new int[] { 1 };
